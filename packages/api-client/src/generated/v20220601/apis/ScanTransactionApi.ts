...
export class ScanTransactionApi extends runtime.BaseAPI {
  /**
   * [DEPRECATED] Use Scan transactions endpoint instead. https://docs.blowfish.xyz/reference/scan-transactions-evm [Sunset] 31.12.2023 Scan an EVM transaction in order to receive recommended actions, tailored warnings and human-readable simulation results explaining what the transaction will do. ### Supported networks | Network | Base URL | | --- | --- | | Ethereum Mainnet | https://api.blowfish.xyz/ethereum/v0/mainnet/scan/transaction | | Goerli Testnet (deprecated) | https://api.blowfish.xyz/ethereum/v0/goerli/scan/transaction | | Sepolia Testnet | https://api.blowfish.xyz/ethereum/v0/sepolia/scan/transaction | | Polygon Mainnet | https://api.blowfish.xyz/polygon/v0/mainnet/scan/transaction | | Polygon Amoy Testnet  | https://api.blowfish.xyz/polygon/v0/amoy/scan/transaction | | BNB Chain Mainnet | https://api.blowfish.xyz/bnb/v0/mainnet/scan/transaction | | Arbitrum One | https://api.blowfish.xyz/arbitrum/v0/one/scan/transaction | | Arbitrum Sepolia Testnet | https://api.blowfish.xyz/arbitrum/v0/sepolia/scan/transaction | | Optimism Mainnet | https://api.blowfish.xyz/optimism/v0/mainnet/scan/transaction | | Optimism Goerli Testnet (deprecated) | https://api.blowfish.xyz/optimism/v0/goerli/scan/transaction | | Optimism Sepolia Testnet | https://api.blowfish.xyz/optimism/v0/sepolia/scan/transaction | | Base Mainnet | https://api.blowfish.xyz/base/v0/mainnet/scan/transaction | | Base Goerli Testnet (deprecated) | https://api.blowfish.xyz/base/v0/goerli/scan/transaction | | Base Sepolia Testnet | https://api.blowfish.xyz/base/v0/sepolia/scan/transaction | | Avalanche Mainnet | https://api.blowfish.xyz/avalanche/v0/mainnet/scan/transaction | | Avalanche Fuji Testnet | https://api.blowfish.xyz/avalanche/v0/fuji/scan/transaction | | Degen Mainnet| https://api.blowfish.xyz/degen/v0/mainnet/scan/transaction | | Blast Mainnet | https://api.blowfish.xyz/blast/v0/mainnet/scan/transaction | | Blast Sepolia | https://api.blowfish.xyz/blast/v0/sepolia/scan/transaction | | Gnosis Mainnet | https://api.blowfish.xyz/gnosis/v0/mainnet/scan/transaction | | Linea Mainnet | https://api.blowfish.xyz/linea/v0/mainnet/scan/transaction | | Zora Mainnet | https://api.blowfish.xyz/zora/v0/mainnet/scan/transaction | Note:  All EVM scan endpoints are equivalent when it comes to functionality as well as request and response formats.  One exception is Zora Mainnet, where ERC20 token prices are currently not supported. `price` for token-related state changes on Zora will always be `null`. NFT prices should work as usual.
   * EVM
   */
