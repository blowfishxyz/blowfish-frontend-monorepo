 ...
 * @export
 */
export type EvmAggregatedSimulationError = { kind: 'SIMULATION_FAILED' } & EvmSimulationFailedError | { kind: 'UNKNOWN_ERROR' } & EvmUnknownError;
/**
 * 
 * @export
...
export interface EvmAggregatedSimulationResults {
     ...
     * @memberof EvmAggregatedSimulationResults
     */
    expectedStateChanges: { [key: string]: Array<EvmExpectedStateChange> | undefined; };
    /**
     * 
     * @type {EvmAggregatedSimulationError}
     * @memberof EvmAggregatedSimulationResults
 ...
 * @export
 */
export type EvmDecodedCalldata = { kind: 'FUNCTION' } & EvmDecodedCalldataFunction | { kind: 'PROXIED_FUNCTION' } & EvmDecodedCalldataProxiedFunction;
/**
...
export type EvmDecodedCalldataFunctionKindEnum = typeof EvmDecodedCalldataFunctionKindEnum[keyof typeof EvmDecodedCalldataFunctionKindEnum];
...
export type EvmDecodedCalldataProxiedFunctionKindEnum = typeof EvmDecodedCalldataProxiedFunctionKindEnum[keyof typeof EvmDecodedCalldataProxiedFunctionKindEnum];
...
export type EvmErc20AssetListsEnum = typeof EvmErc20AssetListsEnum[keyof typeof EvmErc20AssetListsEnum];
 ...
 * @export
 */
export type EvmExpectedStateChangeRawInfo = { kind: 'ERC1155_APPROVAL_FOR_ALL' } & EvmStateChangeErc1155ApprovalForAll | { kind: 'ERC1155_TRANSFER' } & EvmStateChangeErc1155Transfer | { kind: 'ERC20_APPROVAL' } & EvmStateChangeErc20Approval | { kind: 'ERC20_TRANSFER' } & EvmStateChangeErc20Transfer | { kind: 'ERC721_APPROVAL' } & EvmStateChangeErc721Approval | { kind: 'ERC721_APPROVAL_FOR_ALL' } & EvmStateChangeErc721ApprovalForAll | { kind: 'ERC721_LOCK_APPROVAL' } & EvmStateChangeErc721LockApproval | { kind: 'ERC721_LOCK_APPROVAL_FOR_ALL' } & EvmStateChangeErc721LockApprovalForAll | { kind: 'ERC721_TRANSFER' } & EvmStateChangeErc721Transfer | { kind: 'NATIVE_ASSET_TRANSFER' } & EvmStateChangeNativeAssetTransfer;
/**
...
export type EvmMessageStateChangeAnyNftFromCollectionTransferKindEnum = typeof EvmMessageStateChangeAnyNftFromCollectionTransferKindEnum[keyof typeof EvmMessageStateChangeAnyNftFromCollectionTransferKindEnum];
...
export type EvmMessageStateChangeAnyNftFromCollectionTransferDataAssetTypeEnum = typeof EvmMessageStateChangeAnyNftFromCollectionTransferDataAssetTypeEnum[keyof typeof EvmMessageStateChangeAnyNftFromCollectionTransferDataAssetTypeEnum];
...
export type EvmMessageStateChangeErc1155TransferKindEnum = typeof EvmMessageStateChangeErc1155TransferKindEnum[keyof typeof EvmMessageStateChangeErc1155TransferKindEnum];
...
export type EvmMessageStateChangeErc20PermitKindEnum = typeof EvmMessageStateChangeErc20PermitKindEnum[keyof typeof EvmMessageStateChangeErc20PermitKindEnum];
...
export type EvmMessageStateChangeErc20TransferKindEnum = typeof EvmMessageStateChangeErc20TransferKindEnum[keyof typeof EvmMessageStateChangeErc20TransferKindEnum];
...
export type EvmMessageStateChangeErc721TransferKindEnum = typeof EvmMessageStateChangeErc721TransferKindEnum[keyof typeof EvmMessageStateChangeErc721TransferKindEnum];
...
export type EvmMessageStateChangeNativeAssetTransferKindEnum = typeof EvmMessageStateChangeNativeAssetTransferKindEnum[keyof typeof EvmMessageStateChangeNativeAssetTransferKindEnum];
 ...
 * @export
 */
export type EvmPerTransactionError = { kind: 'SIMULATION_FAILED' } & EvmSimulationFailedError | { kind: 'TRANSACTION_ERROR' } & EvmTransactionError | { kind: 'TRANSACTION_REVERTED' } & EvmTransactionRevertedError | { kind: 'UNKNOWN_ERROR' } & EvmUnknownError;
/**
 * 
 * @export
...
export type EvmStateChangeErc721LockApprovalKindEnum = typeof EvmStateChangeErc721LockApprovalKindEnum[keyof typeof EvmStateChangeErc721LockApprovalKindEnum];
...
export type EvmStateChangeErc721LockApprovalForAllKindEnum = typeof EvmStateChangeErc721LockApprovalForAllKindEnum[keyof typeof EvmStateChangeErc721LockApprovalForAllKindEnum];
 ...
 * @export
 */
export type ScanMessageEvm200ResponseSimulationResultsExpectedStateChangesInnerRawInfo = { kind: 'ANY_NFT_FROM_COLLECTION_TRANSFER' } & EvmMessageStateChangeAnyNftFromCollectionTransfer | { kind: 'ERC1155_TRANSFER' } & EvmMessageStateChangeErc1155Transfer | { kind: 'ERC20_PERMIT' } & EvmMessageStateChangeErc20Permit | { kind: 'ERC20_TRANSFER' } & EvmMessageStateChangeErc20Transfer | { kind: 'ERC721_TRANSFER' } & EvmMessageStateChangeErc721Transfer | { kind: 'NATIVE_ASSET_TRANSFER' } & EvmMessageStateChangeNativeAssetTransfer;
/**
 * 
 * @export
