...
export class ScanTransactionsApi extends runtime.BaseAPI {
    ...
    async scanTransactionsEvmRaw(requestParameters: ScanTransactionsEvmOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ScanTransactionsEvm200Response>> {
        ...
        if (requestParameters.chainFamily === null || requestParameters.chainFamily === undefined) {
            throw new runtime.RequiredError('chainFamily','Required parameter requestParameters.chainFamily was null or undefined when calling scanTransactionsEvm.');
        }

        if (requestParameters.chainNetwork === null || requestParameters.chainNetwork === undefined) {
            throw new runtime.RequiredError('chainNetwork','Required parameter requestParameters.chainNetwork was null or undefined when calling scanTransactionsEvm.');
        }
        ...
        const response = await this.request({
            path: `/{chain-family}/v0/{chain-network}/scan/transactions`.replace(`{${"chain-family"}}`, encodeURIComponent(String(requestParameters.chainFamily))).replace(`{${"chain-network"}}`, encodeURIComponent(String(requestParameters.chainNetwork))),
            method: 'POST',
    ...
    async scanTransactionsSolanaRaw(requestParameters: ScanTransactionsSolanaOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ScanTransactionsSolana200Response>> {
        ...
        if (requestParameters.simulationTimeoutMs !== undefined) {
            queryParameters['simulationTimeoutMs'] = requestParameters.simulationTimeoutMs;
        }
...
export type ScanTransactionsEvmOperationChainFamilyEnum = typeof ScanTransactionsEvmOperationChainFamilyEnum[keyof typeof ScanTransactionsEvmOperationChainFamilyEnum];
/**
 * @export
 */
...
export type ScanTransactionsEvmOperationChainNetworkEnum = typeof ScanTransactionsEvmOperationChainNetworkEnum[keyof typeof ScanTransactionsEvmOperationChainNetworkEnum];
/**
 * @export
 */
...
export type ScanTransactionsSolanaOperationSimulateExpiredEnum = typeof ScanTransactionsSolanaOperationSimulateExpiredEnum[keyof typeof ScanTransactionsSolanaOperationSimulateExpiredEnum];
