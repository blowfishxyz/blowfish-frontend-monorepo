...
export class DownloadBlocklistApi extends runtime.BaseAPI {
     ...
     * Blocklist
     */
    async downloadBlocklist(requestParameters: DownloadBlocklistOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<DownloadBlocklist200Response> {
        const response = await this.downloadBlocklistRaw(requestParameters, initOverrides);
