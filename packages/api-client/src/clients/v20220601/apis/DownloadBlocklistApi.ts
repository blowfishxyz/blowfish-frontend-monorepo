...
export class DownloadBlocklistApi extends runtime.BaseAPI {
    ...
    async downloadBlocklistRaw(requestParameters: DownloadBlocklistOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<DownloadBlocklist200Response>> {
        ...
        if (requestParameters.downloadBlocklistRequest === null || requestParameters.downloadBlocklistRequest === undefined) {
            throw new runtime.RequiredError('downloadBlocklistRequest','Required parameter requestParameters.downloadBlocklistRequest was null or undefined when calling downloadBlocklist.');
        }
