...
export class ScanTransactionApi extends runtime.BaseAPI {
  ...
  async scanTransactionEvmRaw(
    ...
    if (
      requestParameters.scanTransactionEvmRequest === null ||
      requestParameters.scanTransactionEvmRequest === undefined
    ) {
      throw new runtime.RequiredError(
        "scanTransactionEvmRequest",
        "Required parameter requestParameters.scanTransactionEvmRequest was null or undefined when calling scanTransactionEvm."
      );
    }
