  ...
  return (
    <>
      <TransactionBlockedScreen
        ...
        message="This dApp is trying to get you to sign as a message what looks like a transaction. We cannot scan the transaction and have no way of knowing what it does. Do not sign it unless you’re absolutely sure of what you’re doing."
